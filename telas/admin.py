...
from .models import Tela, RolloTela, OrdenProduccion, CorteTela, TallaCorte, ComponentesTela
...
class RolloTelaAdmin(admin.ModelAdmin):
    list_display = ('tela', 'largo_inicial', 'largo_restante', 'estado')
    search_fields = ('tela__nombre',)
    list_filter = ('estado',)

@admin.register(OrdenProduccion)
class OrdenProduccionAdmin(admin.ModelAdmin):
    list_display = ('fecha', 'referencia', 'cortador', 'total_unidades')
...
@admin.register(ComponentesTela)
class ComponentesTelaAdmin(admin.ModelAdmin):
